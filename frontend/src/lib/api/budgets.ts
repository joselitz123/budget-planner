...
export class BudgetsApi {
	 ...
	 */
	async addBudgetCategory(budgetId: string, request: AddBudgetCategoryRequest): Promise<BudgetCategory> {
		return apiClient.post<BudgetCategory>(`/budgets/${budgetId}/categories`, request);
	}
}
