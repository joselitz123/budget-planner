  ...
  onMount(async () => {
    try {
      ...
      if (publishableKey) {
        ...
        await clerk.load();
        console.log("[Profile] Clerk successfully initialized");
      } else {
        console.error("[Profile] Missing PUBLIC_CLERK_PUBLISHABLE_KEY");
      }
    } catch (error) {
...
<div class="max-w-2xl mx-auto">
  <Card>
    <div class="p-6">
      <h1
        class="text-2xl font-display font-bold mb-6 text-primary dark:text-white"
      >
        Profile
      </h1>
